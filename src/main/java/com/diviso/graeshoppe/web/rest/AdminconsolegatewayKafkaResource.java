...
@RestController
@RequestMapping("/api/adminconsolegateway-kafka")
public class AdminconsolegatewayKafkaResource {

//    private final Logger log = LoggerFactory.getLogger(AdminconsolegatewayKafkaResource.class);
//
//    private final KafkaProperties kafkaProperties;
//    private KafkaProducer<String, String> producer;
//    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();
//
//    public AdminconsolegatewayKafkaResource(KafkaProperties kafkaProperties) {
