...
class AdminconsolegatewayKafkaResourceIT {
...
//
//        AdminconsolegatewayKafkaResource kafkaResource = new AdminconsolegatewayKafkaResource(kafkaProperties);
//
...
//        restMockMvc.perform(post("/api/adminconsolegateway-kafka/publish/topic-produce?message=value-produce"))
...
//
//        MvcResult mvcResult = restMockMvc.perform(get("/api/adminconsolegateway-kafka/consume?topic=topic-consume"))
//            .andExpect(status().isOk())
